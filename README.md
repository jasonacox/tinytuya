...
3. **Set up a Tuya Account**:
    ...
    * Click on "Cloud" icon -> "Create Cloud Project"
      1. Remember the "Data Center" you select.  This will be used by TinyTuya Wizard ([screenshot](https://user-images.githubusercontent.com/836718/138598647-c9657e49-1a89-4ed6-8105-ceee95d9513f.png)). If you see no devices show up after the completion of this step, you will need to select a different data center and create a new project until you see your paired devices from the *Smart Life App* show up. ([screenshot](https://github.com/cy1110/tinytuya/blob/master/docs/TuyaIOT-server.png))
