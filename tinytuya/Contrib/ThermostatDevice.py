...
class ThermostatDevice(Device):
    ...
    dps_data = {
        ...
        '110': { 'name': 'upper_temp_f', 'alt': 'cooling_setpoint_f', 'scale': 100, 'high_resolution': True },
        '111': { 'name': 'lower_temp_f', 'alt': 'heating_setpoint_f', 'scale': 100, 'high_resolution': True },
