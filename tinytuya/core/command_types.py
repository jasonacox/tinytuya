...
DP_QUERY         = 0x0a  #: FRM_QUERY_STAT      # UPDATE_START_CMD - get data points
QUERY_WIFI       = 0x0b  #: FRM_SSID_QUERY (discard) # UPDATE_TRANS_CMD
TOKEN_BIND       = 0x0c  #: FRM_USER_BIND_REQ   # GET_ONLINE_TIME_CMD - system time (GMT)
CONTROL_NEW      = 0x0d  #: FRM_TP_NEW_CMD      # FACTORY_MODE_CMD
ENABLE_WIFI      = 0x0e  #: FRM_ADD_SUB_DEV_CMD # WIFI_TEST_CMD
WIFI_INFO        = 0x0f  #: FRM_CFG_WIFI_INFO
DP_QUERY_NEW     = 0x10  #: FRM_QUERY_STAT_NEW
SCENE_EXECUTE    = 0x11  #: FRM_SCENE_EXEC
UPDATEDPS        = 0x12  #: FRM_LAN_QUERY_DP    # Request refresh of DPS
UDP_NEW          = 0x13  #: FR_TYPE_ENCRYPTION
AP_CONFIG_NEW    = 0x14  #: FRM_AP_CFG_WF_V40
